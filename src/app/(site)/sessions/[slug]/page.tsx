      ...
      <section className="bg-cream px-5 py-16 text-ink md:px-8 md:py-20">
        ...
        >
          ...
          >
            ...
            <Link href="/sessions/tutors" className={`mt-4 inline-flex items-center gap-2 text-sm font-bold uppercase text-red-700 hover:text-red-600 ${interactiveStateClasses}`}>Meet the Tutors<ArrowRight aria-hidden="true" className="h-4 w-4" /></Link>
          </aside>
